...
RUN apt -y -qq update
RUN apt -y -qq install openssh-server joe rsync nmap tcpdump net-tools iputils-ping telnet psmisc lsb-release wget curl locales-all bind9-dnsutils procps
